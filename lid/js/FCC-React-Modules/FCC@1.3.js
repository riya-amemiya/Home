...
import ModalSimple from "./components/Modal/simples/Modal_simple"; //import Ajax from './function/ajax/Ajax'
...
export { hello, Modal_simple, Accordion, Thedetails //Text,
, Maths, Mathsnew, maths, Random, nCr, nPr, Pow, Repetition, Gcd, Ratio, Diagonal, Zeller, Push, Com, Spt, Window, UTF, Day, Css //Button,
, Aimg //CSS,
, Search //Ajax,
, Time, Html, Code, Consoel //FCC_jQuery
}; //α version